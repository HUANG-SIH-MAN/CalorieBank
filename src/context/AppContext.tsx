...
import { UserProfile, FoodLog, WeightLog, WaterLog } from '../types';
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const loadData = async () => {
    try {
      const [profileStr, foodStr, weightStr, waterStr] = await Promise.all([
  ...
  const value = useMemo(() => ({
    ...
    deleteWaterLog,
    isLoading,
  }), [userProfile, foodLogs, weightLogs, waterLogs, isLoading]);
